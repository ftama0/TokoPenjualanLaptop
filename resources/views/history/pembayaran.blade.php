        ...
        <div class="col-md-12 mt-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('history{id}/detail') }}">Konfirmasi pemesanan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Prosedur Pembayaran</li>
                </ol>
            </nav>
        </div>
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" style="background-color: #cceeff; border:solid 1px #00AA9E">
                    ...
                    <i class="fa fa-mobile" aria-hidden="true"></i></i> Gopay/OVO/ShoppePay : 081259583762 <br />  <br /> 
                        Nominal : <strong>Rp.
